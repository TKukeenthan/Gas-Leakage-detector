...
class APIs {
  ...
  static Future<void> sendPushNotification(
    ...
    try {
      ...
      final sender = user.email;
      final senderName = user.displayName;
      final receiver = chatUser.email;
      final receiverName = chatUser.name;
      final notification = {
        "sender": sender,
  ...
  static Future<void> sendPushNotificationGasLeakage() async {
    try {
  ...
  static Future<bool> addChatUser(String mobile_number) async {
    final data = await firestore
        .collection('users')
        .where('mobile_number', isEqualTo: mobile_number)
        .get();
  ...
  static Future<void> getSelfInfo() async {
    await firestore.collection('users').doc(user.uid).get().then((user) async {
      if (user.exists) {
        ...
        await createUser(APIs.user).then((value) => getSelfInfo());
      }
    });
  }
